    ...
    <main role="main">
                            ...
                            <div class="carousel-content">
                                <div class="padding-2x">
                                    <div class="s-12 m-12 l-8">
                                        ...
                                        >
                                            Prospera is the New Amazing HTML5
                                            Template
                                        </p>
                                        <p
                                ...
                                <div class="padding-2x">
                                    <div class="s-12 m-12 l-8">
                                        <p
                                            class="text-white text-s-size-20 text-m-size-40 text-l-size-60 margin-bottom-40 text-thin text-line-height-1"
                                        >
                                            With Fully Responsive Components
                                        </p>
                                        <p
                                            class="text-white text-size-16 margin-bottom-30"
                                        >
                                            Duis autem vel eum iriure dolor in
            ...
            <div class="full-width text-center">
                ...
                <div class="line">
                    ...
                    <p class="text-size-20 text-s-size-16 text-thin">
                        Duis autem vel eum iriure dolor in hendrerit in
                        vulputate velit esse molestie consequat, vel illum
                        dolore eu feugiat nulla facilisis. Duis autem vel eum
                        iriure dolor in hendrerit in vulputate velit esse
                        molestie consequat, vel illum dolore eu feugiat nulla
                        facilisis
                    </p>
                    <i
                        class="icon-more_node_links icon2x text-primary margin-top-bottom-10"
                    ></i>
                    <p
        ...
        <section class="section background-white">
            <div class="line">
                ...
                >
                    From Our <span class="text-primary">Blog</span>
                </h2>
